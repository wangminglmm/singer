<template>
  <div class="container">
    ...
    <div class="detail">
      <div class="joiner">
        <template v-if="operateType==='join_member'">
          <div class="top">
            <div class="left">
              <div
                class="desc ellipsis"
            ...
            <div class="right" v-if="taskInfo.seller">
        ...
        <template v-else-if="operateType==='join_leader' || operateType === 'own_leader'">
          <div class="song-info">
            <div
                class="lyric ellipsis"
                v-for="(item,index) in taskInfo.lyricList"
                :key="index">{{item}}</div>
              <div class="song">《{{taskInfo.songName}}》 {{taskInfo.songAuthor}}</div>
          </div>
        ...
        <template v-else-if="operateType==='own_member'">
          <div class="own-member">
            ...
            <div class="score">得分：{{taskInfo.leader.score}}</div>
          </div>
        </template>
        <img
